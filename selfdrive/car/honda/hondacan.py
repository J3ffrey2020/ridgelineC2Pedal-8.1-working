...
def create_ui_commands(packer, CP, pcm_speed, hud, is_metric, idx, stock_hud, gap_adjust_cruise, beep, speed_limit_changed):
  commands = []
  ...
  lkas_hud_values = {
    ...
    'BEEP': 1 if beep or speed_limit_changed else 0,
  }
