...
Q_PROPERTY(QString roadName MEMBER roadName NOTIFY valueChanged);
  ...
  Q_PROPERTY(bool devUiEnabled MEMBER devUiEnabled NOTIFY valueChanged);
...
private:
  ...
  int drawDevUiElement(QPainter &p, int x, int y, const char* value, const char* label, const char* units, QColor &color);
