...
SPVehiclesPanel::SPVehiclesPanel(QWidget* parent) : QWidget(parent) {
  ...
  QVBoxLayout* main_layout_toggle = new QVBoxLayout(this);

  main_layout_toggle->addWidget(new LabelControl("Hyundai/Kia/Genesis (HKG)"));
  main_layout_toggle->addWidget(horizontal_line());
  main_layout_toggle->addWidget(new ParamControl("EnhancedScc",
  ...
  main_layout_toggle->addWidget(horizontal_line());
  main_layout_toggle->addWidget(new LabelControl("Toyota", ""));
  main_layout_toggle->addWidget(horizontal_line());
  main_layout_toggle->addWidget(new ParamControl("StockLongToyota",
                                                 ...
                                                 "../assets/offroad/icon_blank.png"));
  main_layout_toggle->addWidget(horizontal_line());
  main_layout_toggle->addWidget(new LabelControl("Volkswagen", ""));
  main_layout_toggle->addWidget(horizontal_line());
  main_layout_toggle->addWidget(new VwAccType());
}
